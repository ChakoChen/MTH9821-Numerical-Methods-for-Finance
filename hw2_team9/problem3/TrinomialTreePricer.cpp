...
// Return the max value of two inputs
...
double TTGreeks(int N, double S0, double K, double T, double q, double r, double v, char PutCall, char EuroAmer, char Greek)
{
    ...
    double G = numeric_limits<double>::quiet_NaN(); // Initialize with quiet_NaN()
    switch(Greek)
    {
...
double TTAmerRD(int N, double S0, double K, double T, double q, double r, double v, char PutCall, char EuroAmer)
{
    double V = numeric_limits<double>::quiet_NaN();
    
    switch(EuroAmer)
    {
        case('E'): V = numeric_limits<double>::quiet_NaN(); break;
        case('A'):
        {
            V = TT(N, S0, K, T, q, r, v, PutCall, 'A')-(TT(N, S0, K, T, q, r, v, PutCall, 'E')- BlackScholes(S0, K, T, v, q, r, PutCall));
            break;
        }
    }
...
double TTGreeksAmerRD(int N, double S0, double K, double T, double q, double r, double v, char PutCall, char EuroAmer, char Greek)
{
    double G = numeric_limits<double>::quiet_NaN();
    
    switch(EuroAmer)
    {
        case('E'): G = numeric_limits<double>::quiet_NaN(); break;
        case('A'):
        {
            G = TTGreeks(N, S0, K, T, q, r, v, PutCall, 'A', Greek) - (TTGreeks(N, S0, K, T, q, r, v, PutCall, 'E', Greek) - BlackScholesGreeks(S0, K, T, v, q, r, PutCall, Greek));
            break;
        }
    }
...
double ATTAmerRD(int N, double S0, double K, double T, double q, double r, double v, char PutCall, char EuroAmer)
{
    double V = numeric_limits<double>::quiet_NaN();
    ...
    switch(EuroAmer)
    {
        ...
        case('A'):
        {
            V = ATT(N, S0, K, T, q, r, v, PutCall, 'A')-(ATT(N, S0, K, T, q, r, v, PutCall, 'E')- BlackScholes(S0, K, T, v, q, r, PutCall));
            break;
        }
    }
...
double ATTGreeksAmerRD(int N, double S0, double K, double T, double q, double r, double v, char PutCall, char EuroAmer, char Greek)
{
    double G = numeric_limits<double>::quiet_NaN();
    ...
    switch(EuroAmer)
    {
        ...
        case('A'):
        {
            G = ATTGreeks(N, S0, K, T, q, r, v, PutCall, 'A', Greek)-(ATTGreeks(N, S0, K, T, q, r, v, PutCall, 'E', Greek)- BlackScholesGreeks(S0, K, T, v, q, r, PutCall, Greek));
            break;
        }
    }
...
double TBSGreeks(int N, double S0, double K, double T, double q, double r, double v, char PutCall, char EuroAmer, char Greek)
{
    ...
    // Compute the Greeks: [delta, gamma, theta]
    double G = numeric_limits<double>::quiet_NaN(); // Initialize with NULL
    switch(Greek)
    {
        case 'D': G = (V[0][1]-V[2][1])/(S[0][1]-S[2][1]); break;
        //case 'G': G = (((V[0][2]-V[2][2])/(S[0][2]-S[2][2]))-((V[2][2]-V[4][2])/(S[2][2]-S[4][2])))/((S[0][2]-S[4][2])/2.0); break;
...
double TBSAmerRD(int N, double S0, double K, double T, double q, double r, double v, char PutCall, char EuroAmer)
{
    double V = numeric_limits<double>::quiet_NaN();
    ...
    switch(EuroAmer)
    {
        ...
        case('A'):
        {
            V = TBS(N, S0, K, T, q, r, v, PutCall, 'A')-(TBS(N, S0, K, T, q, r, v, PutCall, 'E')- BlackScholes(S0, K, T, v, q, r, PutCall));
            break;
        }
    }
...
double TBSGreeksAmerRD(int N, double S0, double K, double T, double q, double r, double v, char PutCall, char EuroAmer, char Greek)
{
    double G = numeric_limits<double>::quiet_NaN();
    ...
    switch(EuroAmer)
    {
        ...
        case('A'):
        {
            G = TBSGreeks(N, S0, K, T, q, r, v, PutCall, 'A', Greek)-(TBSGreeks(N, S0, K, T, q, r, v, PutCall, 'E', Greek)- BlackScholesGreeks(S0, K, T, v, q, r, PutCall, Greek));
            break;
        }
    }
...
double TBSRAmerRD(int N, double S0, double K, double T, double q, double r, double v, char PutCall, char EuroAmer)
{
    double V = numeric_limits<double>::quiet_NaN();
    ...
    switch(EuroAmer)
    {
        ...
        case('A'):
        {
            V = TBSR(N, S0, K, T, q, r, v, PutCall, 'A')-(TBSR(N, S0, K, T, q, r, v, PutCall, 'E')- BlackScholes(S0, K, T, v, q, r, PutCall));
            break;
        }
    }
...
double TBSRGreeksAmerRD(int N, double S0, double K, double T, double q, double r, double v, char PutCall, char EuroAmer, char Greek)
{
    double G = numeric_limits<double>::quiet_NaN();
    ...
    switch(EuroAmer)
    {
        ...
        case('A'):
        {
            G = TBSRGreeks(N, S0, K, T, q, r, v, PutCall, 'A', Greek)-(TBSRGreeks(N, S0, K, T, q, r, v, PutCall, 'E', Greek)- BlackScholesGreeks(S0, K, T, v, q, r, PutCall, Greek));
            break;
        }
    }
...
double PricerRD(int N, double S0, double K, double T, double q, double r, double v, char PutCall, char EuroAmer, int method)
{
    double price = numeric_limits<double>::quiet_NaN();
    switch(method)
    {
        case(1): price =   TTAmerRD(N, S0, K, T, q, r, v, PutCall, EuroAmer); break;
        case(2): price =  ATTAmerRD(N, S0, K, T, q, r, v, PutCall, EuroAmer); break;
        case(3): price =  TBSAmerRD(N, S0, K, T, q, r, v, PutCall, EuroAmer); break;
        case(4): price = TBSRAmerRD(N, S0, K, T, q, r, v, PutCall, EuroAmer); break;
    }
    return price;
}
...
double GreeksRD(int N, double S0, double K, double T, double q, double r, double v, char PutCall, char EuroAmer, char Greek, int method)
{
    double greek = numeric_limits<double>::quiet_NaN();
    switch(method)
    {
        case(1): greek =   TTGreeksAmerRD(N, S0, K, T, q, r, v, PutCall, EuroAmer, Greek); break;
        case(2): greek =  ATTGreeksAmerRD(N, S0, K, T, q, r, v, PutCall, EuroAmer, Greek); break;
        case(3): greek =  TBSGreeksAmerRD(N, S0, K, T, q, r, v, PutCall, EuroAmer, Greek); break;
        case(4): greek = TBSRGreeksAmerRD(N, S0, K, T, q, r, v, PutCall, EuroAmer, Greek); break;
    }
    return greek;
}
